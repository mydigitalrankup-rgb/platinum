...
const customers = [
  { img: "/images/first.jpg",  name: "",            height: 190, width: 140,   },
  { img: "/images/second.jpg", name: "",           height: 250, width: 220, },
  { img: "/images/third.jpg",  name: "Mr. Rajat Sood", height: 350 , width: 285, featured: true },
  { img: "/images/fourth.jpg", name: "",           height: 250, width: 220,},
  { img: "/images/fifth.jpg",  name: "",             height: 190, width: 140,  },
];
    ...
    <>
      <style>{`
        ...
        @media (max-width: 1000px) {
          ...
          .ts-row .ts-card:nth-child(1), .ts-row .ts-card:nth-child(5) { width: 90px !important; height: 112px !important;  }
          .ts-row .ts-card:nth-child(2), .ts-row .ts-card:nth-child(4) { width: 105px !important; height: 142px !important; }
        ...
        @media (max-width: 599px) {
          ...
          .ts-row .ts-card:nth-child(1), .ts-row .ts-card:nth-child(5) { width: 66px !important; height: 87px !important; }
          .ts-row .ts-card:nth-child(2), .ts-row .ts-card:nth-child(4) { width: 81px !important; height: 110px !important;  }
        ...
        @media (max-width: 380px) {
          ...
          .ts-row .ts-card:nth-child(1), .ts-row .ts-card:nth-child(5) { width: 52px !important; height: 69px !important;  }
          .ts-row .ts-card:nth-child(2), .ts-row .ts-card:nth-child(4) { width: 64px !important; height: 88px !important;  }
