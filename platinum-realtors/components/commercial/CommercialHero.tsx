  ...
  return (
    <>
      <style>{`
        ...
        .ch-overlay-red { position: absolute; inset: 0; z-index: 1; background: linear-gradient(to right, rgba(160, 10, 10, 0.53) 0%, rgba(160, 10, 10, 0.28) 28%, rgba(120,10,10,0.18) 48%, transparent 65%); }
